...
class Rob : public RequestPacketizer, public ResponseDepacketizer {
  ...
  private:
    ...
    std::array<std::size_t, axi::NOC_ID_SPACE> read_outstanding_{};
    std::array<uint8_t, axi::NOC_ID_SPACE> read_disabled_dst_{};
    std::array<uint8_t, axi::NOC_ID_SPACE> read_disabled_port_{};
    std::array<axi::AxiClass, axi::NOC_ID_SPACE> read_disabled_cls_{};
    ...
    std::array<uint8_t, NOC_ID_SPACE> prev_port_write_{};
    std::array<uint8_t, NOC_ID_SPACE> prev_port_read_{};
