...
module nmu_request_path #(
    ...
    nmu_request_fifo #(
        ...
        .s_aw_valid_i (internal_req.aw_valid), .s_aw_ready_o (axi_aw_ready), .s_aw_data_i (axi_aw),
        .m_aw_valid_o (fifo_aw_valid), .m_aw_ready_i (fifo_aw_ready),
        .m_aw_data_o (fifo_aw),
        .s_w_valid_i (internal_req.w_valid), .s_w_ready_o (axi_w_ready), .s_w_data_i (axi_w),
        .m_w_valid_o, .m_w_ready_i, .m_w_data_o (m_w_o),
        .s_ar_valid_i (internal_req.ar_valid), .s_ar_ready_o (axi_ar_ready), .s_ar_data_i (axi_ar),
