...
// Adapted from pulp-platform/common_cells cc_fifo.sv @63b7c50d43e462b59506f69d341ff1e40202866d.
// Allows full pop+push replacement; sizes wrap bounds for older simulators.
...
module ni_credit_fifo #(
    ...
    always_comb begin : read_write_comb
        ...
        if (push_i && (~full_o || (pop_i && ~empty_o))) begin
            ...
            if (write_pointer_q == PtrWidth'(FifoDepth - 1))
                write_pointer_n = '0;
            else
        ...
        if (pop_i && ~empty_o) begin
            ...
            // this is dead code when Depth is a power of two
            if (read_pointer_n == PtrWidth'(FifoDepth - 1))
                read_pointer_n = '0;
            else
...
`ifndef COMMON_CELLS_ASSERTS_OFF
    ...
    `ASSERT(full_write, full_o |-> (~push_i || (pop_i && ~empty_o)), clk_i, !rst_ni,
