...
package idma_types_pkg;
    ...
    localparam int unsigned DATA_WIDTH   = ni_params_pkg::AXI_DATA_WIDTH;
    localparam int unsigned ADDR_WIDTH   = ni_params_pkg::AXI_ADDR_WIDTH;
    // The tile crossbar's slave port, which is what the DMA drives.
    localparam int unsigned AXI_ID_WIDTH = ni_params_pkg::AXI_ID_WIDTH;
    localparam int unsigned USER_WIDTH   = ni_params_pkg::AXI_AWUSER_WIDTH;
