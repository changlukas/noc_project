...
// Configuration: 4x4 mesh, 8 DAT VCs, NMU read reorder buffer BYPASSED (RoBless).
//
// The geometry and the address map come from topology_mesh_4x4_pkg, generated
// from sim/topologies/mesh_4x4_vc8.yaml. Everything below the module boundary is
...
module tb_top;
    ...
    localparam int unsigned DAT_NUM_VC       = 8;
    localparam int unsigned READ_ROB_ENABLED = 0;
