...
// Fabric for topology mesh_2x1 (2x1, num_vc=1).
...
`ifndef NOC_FABRIC_MESH_2X1_SV
`define NOC_FABRIC_MESH_2X1_SV

module noc_fabric_mesh_2x1 #(
    ...
    always_ff @(posedge clk_i) begin
        if (rst_ni) begin
            if (n0_link_req_out_valid[RP_NORTH])
                $fatal(1, "noc_fabric: node0 drove a flit on tied-off NORTH (req) - fabric link wiring mistake");
            if (n0_link_rsp_out_valid[RP_NORTH])
                $fatal(1, "noc_fabric: node0 drove a flit on tied-off NORTH (rsp) - fabric link wiring mistake");
            ...
            if (n1_link_req_out_valid[RP_NORTH])
                $fatal(1, "noc_fabric: node1 drove a flit on tied-off NORTH (req) - fabric link wiring mistake");
            if (n1_link_rsp_out_valid[RP_NORTH])
                $fatal(1, "noc_fabric: node1 drove a flit on tied-off NORTH (rsp) - fabric link wiring mistake");
