// Flit <-> FlitBytes byte-array conversions shared by all cosim2 shell adapters.
//
...
// ensures FLIT_BYTES (cosim2 DPI marshalling size) equals Flit::WIDTH_BYTES (c_model
