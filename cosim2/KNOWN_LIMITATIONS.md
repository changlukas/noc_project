...
`c_model/tests/cosim2/test_nmu_shell_adapter.cpp` test
...
`cosim2/sv/wb2axip/faxi_slave.v:805-807`:
```verilog
always @(*)
...
DO NOT modify `cosim2/sv/wb2axip/faxi_slave.v` to silently remove the
