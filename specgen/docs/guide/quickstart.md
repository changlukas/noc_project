...
This writes `generated/cpp/ni_flit_constants.h` from `generated/json/ni_packet.json`.
...
```bash
g++ -std=c++17 -I specgen/generated/cpp examples/use_constants.cpp -o use_constants.exe
```
