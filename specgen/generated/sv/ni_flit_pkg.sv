...
// Generated at: 2026-06-13T03:31:58Z
// ----------------------------------------------------------------------------
...
package ni_flit_pkg;
  ...
  localparam int unsigned FLIT_DATA_WIDTH = 398;
  localparam int unsigned HEADER_DATA_WIDTH = 46;
  ...
  localparam bit          ROUTE_PAR_ENABLED = 1'b1;
  ...
  localparam int unsigned SEQ_LSB     = 34;
  localparam int unsigned SEQ_MSB     = 38;
  localparam int unsigned SEQ_WIDTH   = 5;
  localparam bit          SEQ_ENABLED = 1'b1;
  localparam int unsigned COMMTYPE_LSB     = 39;
  localparam int unsigned COMMTYPE_MSB     = 40;
  localparam int unsigned COMMTYPE_WIDTH   = 2;
  localparam bit          COMMTYPE_ENABLED = 1'b1;
  localparam int unsigned MULTICAST_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          MULTICAST_ENABLED = 1'b0;
  localparam int unsigned FLIT_ECC_LSB     = 41;
  localparam int unsigned FLIT_ECC_MSB     = 50;
  localparam int unsigned FLIT_ECC_WIDTH   = 10;
  localparam bit          FLIT_ECC_ENABLED = 1'b1;
  localparam int unsigned RSVD_LSB     = 51;
  localparam int unsigned RSVD_MSB     = 55;
  localparam int unsigned RSVD_WIDTH   = 5;
