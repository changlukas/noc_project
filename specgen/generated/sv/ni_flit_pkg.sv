...
package ni_flit_pkg;
  ...
  localparam int unsigned COMMTYPE_LSB     = 34;
  localparam int unsigned COMMTYPE_MSB     = 35;
  ...
  localparam bit          MULTICAST_ENABLED = 1'b1;
  ...
  localparam int unsigned RSVD_LSB     = 54;
  localparam int unsigned RSVD_MSB     = 55;
  localparam int unsigned RSVD_WIDTH   = 2;
