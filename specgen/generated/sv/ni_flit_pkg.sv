...
package ni_flit_pkg;
  ...
  localparam int unsigned LAST_LSB     = 22;
  localparam int unsigned LAST_MSB     = 22;
  localparam int unsigned LAST_WIDTH   = 1;
  localparam bit          LAST_ENABLED = 1'b1;
  localparam int unsigned ROB_REQ_LSB     = 23;
  localparam int unsigned ROB_REQ_MSB     = 23;
  localparam int unsigned ROB_REQ_WIDTH   = 1;
  localparam bit          ROB_REQ_ENABLED = 1'b1;
  localparam int unsigned ROB_IDX_LSB     = 24;
  localparam int unsigned ROB_IDX_MSB     = 31;
  localparam int unsigned ROB_IDX_WIDTH   = 8;
