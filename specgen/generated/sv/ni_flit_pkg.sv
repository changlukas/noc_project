...
// Generated at: 2026-08-04T06:09:28Z
// ----------------------------------------------------------------------------
...
package ni_flit_pkg;
  ...
  localparam int unsigned FLIT_WIDTH        = 408;
  localparam int unsigned HEADER_WIDTH      = 56;
  localparam int unsigned PAYLOAD_WIDTH     = 352;
  localparam int unsigned LINK_WIDTH        = 410;
  localparam int unsigned FLIT_DATA_WIDTH = 408;
  localparam int unsigned HEADER_DATA_WIDTH = 56;
  ...
  localparam bit          NOC_QOS_ENABLED = 1'b0;
  ...
  localparam int unsigned ROUTE_PAR_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          ROUTE_PAR_ENABLED = 1'b0;
  localparam int unsigned FLIT_TAIL_LSB     = 22;
  localparam int unsigned FLIT_TAIL_MSB     = 22;
  localparam int unsigned FLIT_TAIL_WIDTH   = 1;
  localparam bit          FLIT_TAIL_ENABLED = 1'b1;
  localparam int unsigned ORDERING_REQ_LSB     = 23;
  localparam int unsigned ORDERING_REQ_MSB     = 23;
  localparam int unsigned ORDERING_REQ_WIDTH   = 1;
  localparam bit          ORDERING_REQ_ENABLED = 1'b1;
  localparam int unsigned ORDERING_TAG_LSB     = 24;
  localparam int unsigned ORDERING_TAG_MSB     = 31;
  localparam int unsigned ORDERING_TAG_WIDTH   = 8;
  localparam bit          ORDERING_TAG_ENABLED = 1'b1;
  localparam int unsigned SEQ_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          SEQ_ENABLED = 1'b0;
  localparam int unsigned COMMTYPE_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          COMMTYPE_ENABLED = 1'b0;
  localparam int unsigned MULTICAST_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          MULTICAST_ENABLED = 1'b0;
  localparam int unsigned FLIT_ECC_WIDTH   = 0;  // reserved placeholder (width=0 -- not in flit)
  localparam bit          FLIT_ECC_ENABLED = 1'b0;
  localparam int unsigned RSVD_LSB     = 32;
  localparam int unsigned RSVD_MSB     = 55;
  localparam int unsigned RSVD_WIDTH   = 24;
  localparam bit          RSVD_ENABLED = 1'b0;

  // --- payload widths per channel (from flit.payload_channels) ---
  localparam int unsigned AW_WIDTH = 112;
  localparam int unsigned AR_WIDTH = 112;
  ...
  localparam int unsigned AW_AWQOS_LSB     = 97;
  localparam int unsigned AW_AWQOS_MSB     = 100;
  localparam int unsigned AW_AWQOS_WIDTH   = 4;
  localparam int unsigned AW_AWUSER_LSB     = 101;
  localparam int unsigned AW_AWUSER_MSB     = 108;
  localparam int unsigned AW_AWUSER_WIDTH   = 8;
  localparam int unsigned AW_AW_RSVD_LSB     = 109;
  localparam int unsigned AW_AW_RSVD_MSB     = 111;
  ...
  localparam int unsigned AR_ARQOS_LSB     = 97;
  localparam int unsigned AR_ARQOS_MSB     = 100;
  localparam int unsigned AR_ARQOS_WIDTH   = 4;
  localparam int unsigned AR_ARUSER_LSB     = 101;
  localparam int unsigned AR_ARUSER_MSB     = 108;
  localparam int unsigned AR_ARUSER_WIDTH   = 8;
  localparam int unsigned AR_AR_RSVD_LSB     = 109;
  localparam int unsigned AR_AR_RSVD_MSB     = 111;
  ...
  localparam int unsigned RSVD_COMMTYPE_WIDTH    = 0;
  ...
  localparam int unsigned HEADER_TOTAL_WIDTH     = 56;

  // --- axi_ch encoding (from flit.header_fields[axi_ch].encoding) ---
  localparam int unsigned AXI_CH_AW  = 0;
  localparam int unsigned AXI_CH_W   = 1;
  localparam int unsigned AXI_CH_AR  = 2;
  localparam int unsigned AXI_CH_B   = 3;
  localparam int unsigned AXI_CH_R   = 4;
