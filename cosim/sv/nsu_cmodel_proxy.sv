...
module nsu_cmodel_proxy #(
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            cmodel_nsu_get_aw(t_awvalid, t_awready,
                              t_awid, t_awaddr,
                              t_awlen, t_awsize, t_awburst,
                              t_awlock, t_awcache,
                              t_awprot, t_awqos);
            cmodel_nsu_get_w(t_wvalid, t_wready,
                             t_wdata, t_wstrb, t_wlast);
            cmodel_nsu_get_ar(t_arvalid, t_arready,
                              t_arid, t_araddr,
                              t_arlen, t_arsize, t_arburst,
                              t_arlock, t_arcache,
                              t_arprot, t_arqos);
            cmodel_nsu_get_b(t_bvalid, t_bready, t_bid, t_bresp);
            cmodel_nsu_get_r(t_rvalid, t_rready, t_rid, t_rdata,
                             t_rresp, t_rlast);
