...
- `sim/test_patterns/README.md` rewrite — already aligned in AXI standardization
...
| Maintained guide | Updated whenever underlying code drifts | `README.md`, `docs/architecture.md`, `docs/development.md`, `sim/test_patterns/README.md`, `spec/ni/README.md` |
...
Existing kept-in-place READMEs (`spec/ni/README.md`, `sim/test_patterns/
...
| `sim/test_patterns/README.md` | Maintained guide | Already aligned in AXI standardization round commit `f13a673`; serves as scenario-author entry point |
...
| Visible maintained docs | 28 | **6** (root README + architecture.md + development.md + sim/test_patterns/README.md + spec/ni/README.md + docs/_archive/README.md) |
| Archived `.md` | 0 | 34 |
...
- Run-all tests: c_model/tests/axi/test_integration.cpp and
  ...
  sim/test_patterns/AX4-*/scenario.yaml)
...
| `sim/test_patterns/README.md` reverts AXI standardization round work | Excluded from rewrite scope; remains as commit `f13a673` left it |
